...
# sddm
# sudo cp $ConfDir/sddm/faces/${ThemeSet}.face.icon /usr/share/sddm/faces/$USER.face.icon
...
#openrgb
ln -fs $ConfDir/OpenRGB/themes/${ThemeSet}.orp $ConfDir/OpenRGB/theme.orp
...
# alacritty
cp -f $ConfDir/alacritty/themes/${ThemeSet}.toml $ConfDir/alacritty/themes/theme.toml
